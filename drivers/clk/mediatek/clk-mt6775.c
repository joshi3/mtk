...
#define PERI_CG3 0xFFFFFFFD		/* FIXME:TODO: wait for Marvin */
...
#define IPU_VCORE_CG			0x00000003
...
static const struct mtk_mux_clr_set_upd top_muxes[] __initconst = {
	...
	MUX_CLR_SET_UPD(CLK_TOP_DPI0_SEL, "dpi0_sel", dpi0_parents, CK_CFG_0,
	CK_CFG_0_SET, CK_CFG_0_CLR, 24, 3, INVALID_MUX_GATE, CLK_TOP_MUX_UPD_CTRL_REG0,
	CLK_TOP_DPI0_SEL_UPD_SHIFT),

	/* CLK_CFG_1 */
	MUX_CLR_SET_UPD(CLK_TOP_MM_SEL, "mm_sel", mm_parents, CK_CFG_1,
	CK_CFG_1_SET, CK_CFG_1_CLR, 0, 4, INVALID_MUX_GATE, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MM_SEL_UPD_SHIFT),
...
static const struct mtk_mux_clr_set_upd top_muxes[] __initconst = {
	...
	CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_DDRPHYCFG_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DPI0_SEL, "dpi0_sel", dpi0_parents, CK_CFG_0,
	CK_CFG_0_SET, CK_CFG_0_CLR, 24, 3, 31, CLK_TOP_MUX_UPD_CTRL_REG0,
	CLK_TOP_DPI0_SEL_UPD_SHIFT),

	/* CLK_CFG_1 */
	MUX_CLR_SET_UPD(CLK_TOP_MM_SEL, "mm_sel", mm_parents, CK_CFG_1,
	CK_CFG_1_SET, CK_CFG_1_CLR, 0, 4, 7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MM_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_PWM_SEL, "pwm_sel", pwm_parents, CK_CFG_1,
	CK_CFG_1_SET, CK_CFG_1_CLR, 8, 2, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_PWM_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DISPPWM_SEL, "disppwm_sel", disppwm_parents, CK_CFG_1,
	CK_CFG_1_SET, CK_CFG_1_CLR, 16, 2, 23, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_DISPPWM_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_VDEC_SEL, "vdec_sel", vdec_parents, CK_CFG_1,
	CK_CFG_1_SET, CK_CFG_1_CLR, 24, 4, 31, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_VDEC_SEL_UPD_SHIFT),

	/* CLK_CFG_2 */
	MUX_CLR_SET_UPD(CLK_TOP_VENC_SEL, "venc_sel", venc_parents, CK_CFG_2,
	CK_CFG_2_SET, CK_CFG_2_CLR, 0, 4, 7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_VENC_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_MFG_SEL, "mfg_sel", mfg_parents, CK_CFG_2,
	CK_CFG_2_SET, CK_CFG_2_CLR, 8, 2, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MFG_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_CAMTG_SEL, "camtg_sel", camtg_parents, CK_CFG_2,
	CK_CFG_2_SET, CK_CFG_2_CLR, 16, 3, 23, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_CAMTG_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_CAMTG2_SEL, "camtg2_sel", camtg2_parents, CK_CFG_2,
	CK_CFG_2_SET, CK_CFG_2_CLR, 24, 3, 31, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_CAMTG2_SEL_UPD_SHIFT),

	/* CLK_CFG_3 */
	MUX_CLR_SET_UPD(CLK_TOP_CAMTG3_SEL, "camtg3_sel", camtg3_parents, CK_CFG_3,
	CK_CFG_3_SET, CK_CFG_3_CLR,	0, 3, 7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_CAMTG3_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_CAMTG4_SEL, "camtg4_sel", camtg4_parents, CK_CFG_3,
	CK_CFG_3_SET, CK_CFG_3_CLR,	8, 3, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_CAMTG4_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_I2C_SEL, "i2c_sel", i2c_parents, CK_CFG_3,
	CK_CFG_3_SET, CK_CFG_3_CLR,	16, 1, 23, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_I2C_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_UART_SEL, "uart_sel", uart_parents, CK_CFG_3,
	CK_CFG_3_SET, CK_CFG_3_CLR, 24, 1, 31, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_UART_SEL_UPD_SHIFT),

	/* CLK_CFG_4 */
	MUX_CLR_SET_UPD(CLK_TOP_SPI_SEL, "spi_sel", spi_parents, CK_CFG_4,
	CK_CFG_4_SET, CK_CFG_4_CLR, 0, 3, 7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_SPI_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_USB30_P0_SEL, "usb30_p0_sel", usb30_p0_parents, CK_CFG_4,
	CK_CFG_4_SET, CK_CFG_4_CLR, 8, 2, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_USB30_P0_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_MSDC50_0_HCLK_SEL, "msdc50_0_hclk_sel", msdc50_0_hclk_parents, CK_CFG_4,
	CK_CFG_4_SET, CK_CFG_4_CLR, 16, 3, 23, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MSDC50_0_HCLK_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_MSDC50_0_SEL, "msdc50_0_sel", msdc50_0_parents, CK_CFG_4,
	CK_CFG_4_SET, CK_CFG_4_CLR, 24, 3, 31, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MSDC50_0_SEL_UPD_SHIFT),

	/* CLK_CFG_5 */
	MUX_CLR_SET_UPD(CLK_TOP_MSDC30_1_SEL, "msdc30_1_sel", msdc30_1_parents, CK_CFG_5,
	CK_CFG_5_SET, CK_CFG_5_CLR, 0, 3, 7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MSDC30_1_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_I3C_SEL, "i3c_sel", i3c_parents, CK_CFG_5,
	CK_CFG_5_SET, CK_CFG_5_CLR, 8, 2, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_I3C_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_MSDC30_3_SEL, "msdc30_3_sel", msdc30_3_parents, CK_CFG_5,
	CK_CFG_5_SET, CK_CFG_5_CLR, 16, 4, 23, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MSDC30_3_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_MSDC50_3_HCLK_SEL, "msdc50_3_hsel_sel", msdc50_3_hsel_parents, CK_CFG_5,
	CK_CFG_5_SET, CK_CFG_5_CLR, 24, 2, 31, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_MSDC50_3_HCLK_SEL_UPD_SHIFT),

	/* CLK_CFG_6 */
	MUX_CLR_SET_UPD(CLK_TOP_AUDIO_SEL, "audio_sel", audio_parents, CK_CFG_6,
	CK_CFG_6_SET, CK_CFG_6_CLR, 0, 2, 7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_AUDIO_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_AUD_INTBUS_SEL, "aud_intbus_sel", aud_intbus_parents, CK_CFG_6,
	CK_CFG_6_SET, CK_CFG_6_CLR, 8, 3, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_AUD_INTBUS_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_PMICSPI_SEL, "pmicspi_sel", pmicspi_parents, CK_CFG_6,
	CK_CFG_6_SET, CK_CFG_6_CLR, 16, 3, 23, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_PMICSPI_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_SCP_SEL, "scp_sel", scp_parents, CK_CFG_6,
	CK_CFG_6_SET, CK_CFG_6_CLR, 24, 3, 31, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_SCP_SEL_UPD_SHIFT),

	/* CLK_CFG_7 */
	MUX_CLR_SET_UPD(CLK_TOP_ATB_SEL, "atb_sel", atb_parents, CK_CFG_7,
	CK_CFG_7_SET, CK_CFG_7_CLR, 0, 2, 7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_ATB_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DSP_SEL, "dsp_sel", dsp_parents, CK_CFG_7,
	CK_CFG_7_SET, CK_CFG_7_CLR, 8, 4, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_DSP_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_AUD_1_SEL, "aud_1_sel", aud_1_parents, CK_CFG_7,
	CK_CFG_7_SET, CK_CFG_7_CLR, 16, 1, 23, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_AUD_1_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_AUD_2_SEL, "aud_2_sel", aud_2_parents, CK_CFG_7,
	CK_CFG_7_SET, CK_CFG_7_CLR, 24, 1, 31, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_AUD_2_SEL_UPD_SHIFT),

	/* CLK_CFG_8 */
	MUX_CLR_SET_UPD(CLK_TOP_AUD_ENGEN1_SEL, "aud_engen1_sel", aud_engen1_parents, CK_CFG_8,
	CK_CFG_8_SET, CK_CFG_8_CLR,	0, 2, 7, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_AUD_ENGEN1_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_AUD_ENGEN2_SEL, "aud_engen2_sel", aud_engen2_parents, CK_CFG_8,
	CK_CFG_8_SET, CK_CFG_8_CLR,	8, 2, 15, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_AUD_ENGEN2_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DFP_MFG_SEL, "dfp_mfg_sel", dfp_mfg_parents, CK_CFG_8,
	CK_CFG_8_SET, CK_CFG_8_CLR, 16, 2, 23, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_DFP_MFG_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_CAM_SEL, "cam_sel", cam_parents, CK_CFG_8,
	CK_CFG_8_SET, CK_CFG_8_CLR, 24, 4, 31, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_CAM_SEL_UPD_SHIFT),

	/* CLK_CFG_9 */
	MUX_CLR_SET_UPD(CLK_TOP_IPU_IF_SEL, "ipu_if_sel", ipu_if_parents, CK_CFG_9,
	CK_CFG_9_SET, CK_CFG_9_CLR, 0, 4, 7, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_IPU_IF_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_IMG_SEL, "img_sel", img_parents, CK_CFG_9,
	CK_CFG_9_SET, CK_CFG_9_CLR, 8, 4, 15, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_IMG_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_AES_UFSFDE_SEL, "aes_ufsfde_sel", aes_ufsfde_parents, CK_CFG_9,
	CK_CFG_9_SET, CK_CFG_9_CLR, 16, 3, 23, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_AES_UFSFDE_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_AUDIO_H_SEL, "audio_h_sel", audio_h_parents, CK_CFG_9,
	CK_CFG_9_SET, CK_CFG_9_CLR, 24, 2, 31, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_AUDIO_H_SEL_UPD_SHIFT),

	/* CLK_CFG_10 */
	MUX_CLR_SET_UPD(CLK_TOP_SSPM_SEL, "sspm_sel", sspm_parents, CK_CFG_10,
	CK_CFG_10_SET, CK_CFG_10_CLR, 0, 3, 7, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_SSPM_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_UFS_CARD_SEL, "ufs_card_sel", ufs_card_parents, CK_CFG_10,
	CK_CFG_10_SET, CK_CFG_10_CLR, 8, 2, 15, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_UFS_CARD_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_BSI_SPI_SEL, "bsi_spi_sel", bsi_spi_parents, CK_CFG_10,
	CK_CFG_10_SET, CK_CFG_10_CLR, 16, 2, 23, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_BSI_SPI_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DXCC_SEL, "dxcc_sel", dxcc_parents, CK_CFG_10,
	CK_CFG_10_SET, CK_CFG_10_CLR, 24, 2, 31, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_DXCC_SEL_UPD_SHIFT),

	/* CLK_CFG_11 */
	MUX_CLR_SET_UPD(CLK_TOP_SENINF_SEL, "seninf_sel", seninf_parents, CK_CFG_11,
	CK_CFG_11_SET, CK_CFG_11_CLR, 0, 2, 7, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_SENINF_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DFP_SEL, "dfp_sel", dfp_parents, CK_CFG_11,
	CK_CFG_11_SET, CK_CFG_11_CLR, 8, 2, 15, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_DFP_SEL_UPD_SHIFT),

	/* CLK_CFG_12 */
	MUX_CLR_SET_UPD(CLK_TOP_DSP1_SEL, "dsp1_sel", dsp1_parents, CK_CFG_12,
	CK_CFG_12_SET, CK_CFG_12_CLR, 0,  4,  7, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_DSP1_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DSP2_SEL, "dsp2_sel", dsp2_parents, CK_CFG_12,
	CK_CFG_12_SET, CK_CFG_12_CLR, 8,  4, 15, CLK_TOP_MUX_UPD_CTRL_REG0, CLK_TOP_DSP2_SEL_UPD_SHIFT),
	MUX_CLR_SET_UPD(CLK_TOP_DSP3_SEL, "dsp3_sel", dsp3_parents, CK_CFG_12,
	CK_CFG_12_SET, CK_CFG_12_CLR, 16, 4, 23, CLK_TOP_MUX_UPD_CTRL_REG1, CLK_TOP_DSP3_SEL_UPD_SHIFT),
...
static const struct mtk_gate ipu_conn_clks[] __initconst = {
	...
	GATE_IPU_CONN(CLK_IPU_CONN_AXI_CG, "ipu_conn_axi", "dfp_sel", 2),
	GATE_IPU_CONN(CLK_IPU_CONN_ISP_CG, "ipu_conn_isp", "dfp_sel", 3),
...
static const struct mtk_gate ipu_vcore_clks[] __initconst = {
	GATE_IPU_VCORE(CLK_IPU_VCORE_AHB_CG, "ipu_vcore_ahb", "dsp_sel", 0),
	GATE_IPU_VCORE(CLK_IPU_VCORE_AXI_CG, "ipu_vcore_axi", "dsp_sel", 1),
	GATE_IPU_VCORE(CLK_IPU_VCORE_ADL_CG, "ipu_vcore_adl", "dsp_sel", 2),
};
...
static const struct mtk_gate ipu_core0_clks[] __initconst = {
	GATE_IPU_CORE0(CLK_IPU_CORE0_JTAG_CG, "ipu_core0_jtag", "dsp_sel", 0),
	GATE_IPU_CORE0(CLK_IPU_CORE0_AXI_M_CG, "ipu_core0_axi", "dsp_sel", 1),
	GATE_IPU_CORE0(CLK_IPU_CORE0_IPU_CG, "ipu_core0_ipu", "dsp_sel", 2),
};
...
static const struct mtk_gate ipu_core1_clks[] __initconst = {
	GATE_IPU_CORE1(CLK_IPU_CORE1_JTAG_CG, "ipu_core1_jtag", "dsp_sel", 0),
	GATE_IPU_CORE1(CLK_IPU_CORE1_AXI_M_CG, "ipu_core1_axi", "dsp_sel", 1),
	GATE_IPU_CORE1(CLK_IPU_CORE1_IPU_CG, "ipu_core1_ipu", "dsp_sel", 2),
};
...
static const struct mtk_gate ipu_core2_clks[] __initconst = {
	GATE_IPU_CORE2(CLK_IPU_CORE2_JTAG_CG, "ipu_core2_jtag", "dsp_sel", 0),
	GATE_IPU_CORE2(CLK_IPU_CORE2_AXI_M_CG, "ipu_core2_axi", "dsp_sel", 1),
	GATE_IPU_CORE2(CLK_IPU_CORE2_IPU_CG, "ipu_core2_ipu", "dsp_sel", 2),
};
