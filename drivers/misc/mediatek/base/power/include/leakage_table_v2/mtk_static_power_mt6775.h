...
#define DEF_CPUL_LEAKAGE    22
#define DEF_CPUB_LEAKAGE    52
#define DEF_CCI_LEAKAGE      1
#define DEF_GPU_LEAKAGE      8
#define DEF_VCORE_LEAKAGE   16
#define DEF_MODEM_LEAKAGE    7
#define DEF_VPU_LEAKAGE      3
...
#define CCI_DEVINFO_DOMAIN (BIT(MTK_SPOWER_CPUL) | BIT(MTK_SPOWER_CPUL_CLUSTER))
