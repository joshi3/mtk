...
#ifndef _MTK_MT6758_H_
#define _MTK_MT6758_H_
...
#define PLATFORM_SOC_CHIP 0x6758
/*tag end*/

/*device tree mode*/
#if CONFIG_OF
/* A-Die interface pinmux base */
#define CONSYS_IF_PINMUX_REG_BASE	0x102D0300
#define CONSYS_IF_PINMUX_01_OFFSET	0x000000B0
#define CONSYS_IF_PINMUX_01_MASK	0x88888888
#define CONSYS_IF_PINMUX_01_VALUE	0x22222222
#define CONSYS_IF_PINMUX_02_OFFSET	0x000000C0
...
#define CONSYS_AFE_REG_BASE			(0x190B6000)
